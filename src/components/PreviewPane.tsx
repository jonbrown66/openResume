...
export const PreviewPane = memo(function PreviewPane({
  ...
  return (
    <div className="group/preview relative flex h-full min-w-0 flex-1 flex-col bg-[var(--app-bg)] transition-colors duration-200 print:flex print:w-full">
      ...
      <div ref={containerRef} className="flex flex-1 items-start justify-start overflow-y-auto overflow-x-hidden px-3 pt-16 pb-24 custom-scrollbar [contain:layout_paint_style] sm:px-8 sm:pt-20 sm:pb-12 lg:px-10 lg:pt-24">
